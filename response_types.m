...
% % % % % % % %     %%% electrode info
% % % % % % % %     elc_info_row = strcmp(elc_info.electrode , resp.chan{ichan});
% % % % % % % %     resp.HCPMMP1_label_1{ichan} = elc_info.HCPMMP1_label_1(elc_info_row);
...
info_vars_to_copy = {'electrode','type','connector','port','strip','comment','target','side','nat_x','nat_y','nat_z',...
