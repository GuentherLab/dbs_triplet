...
%%%%%%% other hg subcort examples which show peak before each syllable onset: DBS3019_macro_c, DBS4077_dbs_L1
% plotop.elc_param = 'p_prep'; 
% plotop.trial_sort_param = [];
% plotop.sub_elc = {  {'DBS3028','ecog_158'},{'DBS4077','dbs_L2C'};... % beta
%                     {'DBS3004','ecog_135'}, {'DBS4083','dbs_R3'} };  % hg
...
tile_index = (plotop.tile_row(1) - 1) * plotop.ncols + 1; % Calculate the tile index
nexttile
param = plotop.elc_param;
compare_areal_tuning_triplet();

%%% example timecourse 1
tile_index = (plotop.tile_row(1) - 1) * plotop.ncols + 2; % Calculate the tile index
