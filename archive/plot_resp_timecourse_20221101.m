...
xline_col_stim_syl_on = [0.3 0.3 0.8];
xline_col_stim_syl_off = [0.8 0.3 0.3];
xline_col_prod_syl_on = [0.7 0.7 0.7];
xline_col_prod_syl_off = [0.3 0.3 0.3];
xline_style = '--';
xline_width = 0.25; 
...
%%%% how to how to find the time length that trials will be cut/padded to be
...
htitle = title(resp.chan{erow}, 'Interpreter','none');

% stim syllable onsets
hstim_syl(1) = xline(xline_fn(trials_tmp.stim_syl_on_adj(:,1),'omitnan'), 'LineWidth',xline_width, 'Color',xline_col_stim_syl_on, 'LineStyle',xline_style);
hstim_syl(2) = xline(xline_fn(trials_tmp.stim_syl_on_adj(:,2),'omitnan'), 'LineWidth',xline_width, 'Color',xline_col_stim_syl_on, 'LineStyle',xline_style);
hstim_syl(3) = xline(xline_fn(trials_tmp.stim_syl_on_adj(:,3),'omitnan'), 'LineWidth',xline_width, 'Color',xline_col_stim_syl_on, 'LineStyle',xline_style);

% stim offset
hstim_syl(3) = xline(mean(trials_tmp.stim_syl_off_adj(:,3),'omitnan'), 'LineWidth',xline_width, 'Color',xline_col_stim_syl_off, 'LineStyle',xline_style);

% produced syllable onsets
hprod_syl(1) = xline(0, 'LineWidth',xline_width, 'Color',xline_col_prod_syl_on, 'LineStyle',xline_style); 
hprod_syl(2) = xline(xline_fn(trials_tmp.prod_syl_on_adj(:,2),'omitnan'), 'LineWidth',xline_width, 'Color',xline_col_prod_syl_on, 'LineStyle',xline_style);
hprod_syl(3) = xline(xline_fn(trials_tmp.prod_syl_on_adj(:,3),'omitnan'), 'LineWidth',xline_width, 'Color',xline_col_prod_syl_on, 'LineStyle',xline_style);

% produced syllable offsets
hprod_syl(2) = xline(xline_fn(trials_tmp.prod_syl_off_adj(:,1),'omitnan'), 'LineWidth',xline_width, 'Color',xline_col_prod_syl_off, 'LineStyle',xline_style);
hprod_syl(2) = xline(xline_fn(trials_tmp.prod_syl_off_adj(:,2),'omitnan'), 'LineWidth',xline_width, 'Color',xline_col_prod_syl_off, 'LineStyle',xline_style);
hprod_syl(3) = xline(xline_fn(trials_tmp.prod_syl_off_adj(:,3),'omitnan'), 'LineWidth',xline_width, 'Color',xline_col_prod_syl_off, 'LineStyle',xline_style);
