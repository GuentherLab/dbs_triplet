...
switch inclusion_mode
    ...
    case 'proportion'
        ...
        cutoff_ind = round(p_proportion * n_elc); % elcs at this rank and above within rows_ranked are treated as significant
        sgn_rows = false(n_elc,1); 
        sgn_rows(rows_ranked(1:cutoff_ind)) = true; 
end
