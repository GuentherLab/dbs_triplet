% Function to plot phonotactic probabilities vs reaction time with log scale and jitter
function plot_phonotactic_vs_rt_per_dbs3(reactiontime_table, phonotacticProbabilities, transitions, dbsID, trans_field)
    ...
    % Manually define a set of distinct colors, including a mustard color
    colors = [...
        ...
        0.83 0.65 0.15];  % Mustard Yellow (replacing bright yellow)
    ...
    % Add a legend to identify the transitions
