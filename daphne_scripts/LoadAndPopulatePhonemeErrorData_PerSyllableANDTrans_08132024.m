        ...
        if exist(phonemeFilePath, 'file')
            ...
            if ismember('phonetic_ontarget', subtable.phoneme_tables{i_sub}.Properties.VariableNames)
                ...
                for itrial = 1:ntrials
                    ...
                    % Initialize error counts for the three syllables and transitions
                    errors_syl1 = 0;
                    errors_syl2 = 0;
                    errors_syl3 = 0;
                    error_trans1 = 0;
                    ...
                    for isyl = 1:3
                        ...
                        elseif isyl == 2
                            ...
                            % Calculate transition 1 errors (Syllable 1 to 2)
                            error_trans1 = errors_syl1 + errors_syl2;
                        elseif isyl == 3
                            errors_syl3 = total_errors;
                            % Calculate transition 2 errors (Syllable 2 to 3)
...
%Rationale for using different method b/w trans1 + trans2 behavioral = neural resources into executing this difficult transitions it makes it difficult to complete syllable 2 - even though its not directly - its still within the transitions
%Could look at reaction time 
% Could look at duration 