...
load([PATH_SUBJECT filesep 'Preprocessed Data' filesep 'FieldTrip'...
    filesep SUBJECT '_ft_raw_filt_trial_ar_ref_criteria_' ARTIFACT_CRIT '.mat']);
...
save([PATH_SAVE_PREPROCESSED filesep SUBJECT...
    '_ft_hg_trial_criteria_' ARTIFACT_CRIT '.mat'],...
    'D_hg','-v7.3');
