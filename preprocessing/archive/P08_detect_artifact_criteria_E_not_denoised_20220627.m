...
% compute log-spaced frequencies between wav_freq_min and wav_freq_max
    ...
    nchannels = length(D_hpf_eltype.label);
    ...
    D_hg_eltype = struct; % initialize; averaged high gamma
    ...
    for iblock = 1:nTrials
        ...
        D_hg_eltype.trial{iblock} = D_hg_eltype.trial{iblock} .* med_pow_mean(:,iblock); 
    end
